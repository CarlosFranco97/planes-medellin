            ...
            <div className="flex flex-col gap-6 md:gap-8">
              ...
              <div className="grid grid-cols-1 gap-6 md:gap-8 pb-20 md:pb-4">
                ...
                <div className="bg-white/80 rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-[#0080B9] text-base md:text-lg lg:text-xl leading-relaxed text-justify">
                    Parque de los hipopotamos, santuario de fauna y flora,
                    parque jurasico, museo africano, la gran sabana africana,
                    pista aerea, museo memorial, caballerizas, biolandia,
                    paraque del conocimiento, habitat de los felinos, isla de
                    los monos, apreciación de Vanessa y el habitat de los
                    suricatos El pasaporte permite acceder al parque acuatico o
                    zona de piscina, acuasaurus que incluye también octopus
                ...
                <div className="bg-white/80 rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <p className="text-[#0080B9] text-base md:text-lg lg:text-xl leading-relaxed text-justify">
                    Incluye todas las atracciones mencionadas en el pasaporte
                    aventura mas río salvaje, cobras y cataratas victoria, guía
                    acompañante durante todo el recorrido, tarjeta asistencia
                    medica (Llevar traje de baño)
                  </p>
                </div>
              </div>
            </div>
