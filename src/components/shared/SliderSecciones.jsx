                ...
                >
                    <div className="flex flex-col gap-6 md:gap-8">
                        <h1 className="text-yellow-300 text-center font-extrabold text-3xl md:text-4xl lg:text-5xl drop-shadow-md top-12 md:top-0 bg-white/80 backdrop-blur-sm py-4 rounded-lg">
                            {contenidoSlider.title}
                        </h1>

                        <div className="grid grid-cols-1 gap-6 md:gap-8 pb-20 md:pb-4">
                            {contenidoSlider.sections.map((section, sectionIndex) => (
                                <div
                                    key={sectionIndex}
                                    className="bg-white/80 rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300"
                                >
                                    <h2 className="text-yellow-300 text-center font-extrabold text-2xl md:text-3xl mb-4 md:mb-6">
                                        {section.title}
                                    </h2>
...
export default SliderSecciones;
