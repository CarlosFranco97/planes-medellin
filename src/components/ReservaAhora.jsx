...
const ReservaAhora = () => {
    ...
    return (
        <section className="min-h-screen w-full max-w-[1600px] flex justify-center lg:h-[150vh] xl:h-[350vh]">
            
            <div className="bg-[url(../src/assets/tour-guatape.png)] bg-no-repeat bg-contain bg-center flex flex-col justify-between items-center min-h-screen w-[80%] xl:justify-around 2xl:justify-around">
